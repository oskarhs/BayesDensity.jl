...
Although nonparametric density estimation is often used for simple univariate data visualizations, it is routinely used for more complex modeling tasks. We encourage you to also have a look at the [Examples](examples/naive_bayes.md) section of the documentation, which showcases the application of BayesDensity.jl to problems beyond mere data visualization.