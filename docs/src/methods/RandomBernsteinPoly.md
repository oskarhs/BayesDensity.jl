...
This module implements the Gibbs sampler of [Petrone1999bernstein](@citet) for Markov chain Monte Carlo-based posterior inference. We refer the interested reader to the same paper for a discussion of the role of the `prior_strength` hyperparameter.
